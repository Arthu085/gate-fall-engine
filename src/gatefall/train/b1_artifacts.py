...
from gatefall.train.b1_config import B1TrainConfig, load_config
from gatefall.train.b1_model import B1AdaptiveGateClassifier
from gatefall.train.metrics import RESTRICTED_CLASSES

REQUIRED_B1_TRAINING_ARTIFACTS = ("config.yaml", "metrics.json", "checkpoint.pt")
...
def validate_b1_training_metrics(
    data: object,
